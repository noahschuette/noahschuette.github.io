...
function load() {
    html = {
        spotify : {
        parent : document.getElementById("spotifyParent"),
        ...
        listeningto : document.getElementById("spotifyListeningTo"),
        }
    }
    loadSpotify();
}
...
function replaceSpotify(json) {
    ...
    html.spotify.parent.style.backgroundColor = toRGBString(rgb.dark3);
    html.spotify.parent.style.filter = toDropShadowString(rgb.dark2);
    html.spotify.album.style.color = toRGBString(rgb.light2);
    html.spotify.artist.style.color = toRGBString(rgb.light1);
    html.spotify.title.style.color = toRGBString(rgb.light1);
    html.spotify.listeningto.style.color = toRGBString(rgb.light1);
...
function toDropShadowString(color) {
    return 'drop-shadow(4px 4px 0px rgb(' + color.r + ',' + color.g + ',' + color.b + '))';
}